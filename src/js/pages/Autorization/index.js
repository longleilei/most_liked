  ...
  let form = document.forms["aut-form"];
    ...
    form.addEventListener('submit', (e) => {
      ...
      let userInfo = {
        ...
        gender_orientation: form.elements['Gender'].value,
        city: form.elements['City'].value,
        country: form.elements['Country'].value,
        date_of_birth_day:form.elements['dob-day'].value,
        date_of_birth_month: form.elements['dob-month'].value,
        date_of_birth_year:form.elements['dob-year'].value,

      
      
      /*{
        email: "gibajax553@provmail.com",
        password: "5463267hgk",
        nickname: "dmgame",
        first_name: "Denis",
      ...
      //if (!userInfo.email || !userInfo.lastName || !userInfo.userName || !userInfo.city || userInfo.state) return;
